insert into usr (id, email, faculty, name, password, role, web_money_account)
            values (1, 'mail1', 0, 'name1', 1234, 3, 9999);

insert into usr (id, email, faculty, name, password, role, web_money_account)
            values (2, 'mail12', 0, 'name2', 2222, 2, 9999);

insert into message (id, message_body, message_head, sender_user_id, recipient_user_id)
            values (1, 'i can do it', 'for task', 2, 1);
