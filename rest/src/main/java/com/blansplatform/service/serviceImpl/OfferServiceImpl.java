...
public class OfferServiceImpl implements OfferService {
    ...
    @Autowired
    public OfferServiceImpl(OfferRepository offerRepository, UserRepository userRepository, TaskRepository taskRepository, UserService userService, OfferFromOfferDto offerFromOfferDto) {
